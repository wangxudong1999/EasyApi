...
/**
 * @ClassName NoIdUtils
 * @Date 2018/12/27 2:23 PM
 * @Author WangXuDong
 **/
public class NoIdUtils extends StringUtils{


    public static void main(String[] args) {
        NoIdUtils cre = new NoIdUtils();
        String randomID = cre.getRandomID(20,21);
        //获取身份证号
        System.out.println(randomID);
        //年龄
        System.err.print(cre.getAgeByIdCard(randomID));
        //出生年月日
        System.err.print(cre.getBirthByIdCard(randomID));
        //性别
        System.err.print(cre.getGenderByIdCard(randomID));
        //省份
        System.err.print(cre.getProvinceByIdCard(randomID));
        //获取姓名
        System.err.print(cre.getName());
     ...
     * @return
     */
    public String getRandomID(int minAge, int maxAge) {
